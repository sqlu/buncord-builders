...
> [!TIP]
> **Performance Boost:** With over **6.3x performance** (more than 531% faster processing), `@discordts/builders` eliminates instantiation and serialization bottlenecks entirely, running close to 0ms overhead.
...
| :--- | :--- | :--- | :---: |
| **Instantiation** | ~184.0 ms | **~23.5 ms** | **7.8x faster** |
| **Serialization** | ~56.9 ms | **~14.7 ms** | **3.9x faster** |
| **Total** | ~240.9 ms | **~38.2 ms** | **6.3x faster** |
